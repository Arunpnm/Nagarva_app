...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        // Session 4, Part C-3.
        FFRoute(
          name: LrRegisterPageWidget.routeName,
        ...
        // Session 4, Part C-6.
        FFRoute(
          name: VendorsPageWidget.routeName,
          path: VendorsPageWidget.routePath,
          builder: (context, params) => const VendorsPageWidget(),
        ),
        FFRoute(
          name: VendorDetailPageWidget.routeName,
          path: VendorDetailPageWidget.routePath,
          builder: (context, params) => VendorDetailPageWidget(
            vendorId: params.getParam('vendorId', ParamType.String),
          ),
        ),
        // Session 4, Part C-7.
        FFRoute(
          ...
          builder: (context, params) => const CustomersPageWidget(),
        ),
        FFRoute(
          name: CustomerDetailPageWidget.routeName,
          path: CustomerDetailPageWidget.routePath,
        ...
        // Session 4, Part C-9.
        FFRoute(
          name: TripsPageWidget.routeName,
          path: TripsPageWidget.routePath,
          builder: (context, params) => const TripsPageWidget(),
        ),
        FFRoute(
          name: TripDetailPageWidget.routeName,
          path: TripDetailPageWidget.routePath,
          builder: (context, params) => TripDetailPageWidget(
