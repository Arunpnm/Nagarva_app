    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case OrderStaffRow:
            return OrderStaffRow(data);
          case OrderTrackingRow:
            return OrderTrackingRow(data);
          case OrdersRow:
            return OrdersRow(data);
          case PricingConfigRow:
            return PricingConfigRow(data);
          case QuotationsRow:
            return QuotationsRow(data);
          case RemindersRow:
          ...
          case StaffAdvancesRow:
            return StaffAdvancesRow(data);
          case VehicleTripsRow:
            return VehicleTripsRow(data);
          case AttendanceViewRow:
            return AttendanceViewRow(data);
          case AdvancesViewRow:
            return AdvancesViewRow(data);
          case TripsViewRow:
            return TripsViewRow(data);
          case RemindersViewRow:
            return RemindersViewRow(data);
          case DashboardKpisViewRow:
            return DashboardKpisViewRow(data);
          case BranchKpisViewRow:
            return BranchKpisViewRow(data);
          default:
            return null;
        }
