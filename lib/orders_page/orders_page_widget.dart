                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Builder(
                          builder: (context) {
                            final ordersListItem = _model.ordersList.toList();
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemBuilder:
                                      ...
                                      final confirmedOrderItem =
                                          confirmedOrder[confirmedOrderIndex];
                                      return Container(
                                        width: double.infinity,
                                        decoration: BoxDecoration(
                                          color: FlutterFlowTheme.of(context)
                        ...
                        if (_model.selectedTab == 'Done')
                          Column(
                            ...
                            children: [
                              Builder(
                                builder: (context) {
                                  final doneOrder = _model.doneOrders.toList();
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemBuilder:
                                      ...
                                      final cancelledOrderItem =
                                          cancelledOrder[cancelledOrderIndex];
                                      return Container(
                                        width: double.infinity,
                                        decoration: BoxDecoration(
                                          color: FlutterFlowTheme.of(context)
